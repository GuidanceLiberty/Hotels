...
const Reservation = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setMessage({
      type: 'success',
      text: `Availability checked for ${adults} adult(s) and ${children} child(ren) from ${checkIn} to ${checkOut}.`,
    });
  };
  ...
  return (
    <section className="py-12 bg-accent-secondary dark:bg-primary transition-colors duration-300">
      <form
        ...
        className="max-w-md mx-auto bg-white dark:bg-gray-900 rounded-xl shadow-lg p-8 text-center"
      >

  ...
  return (
    <section className='bg-accent mb-0 pb-0'>
        ...
        <div className="project__grid grid grid-cols-1 lg:grid-cols-2 lg:gap-2">
                <div data-aos="zoom-in"  className="w-full h-[600] relative overflow-hidden rounded-none lg:rounded-2xl shadow-lg mt-8 ">
                    <img  src={theme_1} alt="holiday escape" className='w-full h-full object-cover' />
                    
                </div>

                <div data-aos="zoom-out" className="w-full h-[600] relative overflow-hidden rounded-none lg:rounded-2xl shadow-lg lg:mt-8 ">
                    <img src={theme_2} alt="holiday escape" className='w-full h-full object-cover' />
                    
                </div>

                <div data-aos="flip-right"  className="w-full h-[600] relative overflow-hidden rounded-none lg:rounded-2xl shadow-lg">
                ...
                <div data-aos="fade-up" className="w-full h-[600] relative overflow-hidden rounded-none lg:rounded-2xl shadow-lg  ">

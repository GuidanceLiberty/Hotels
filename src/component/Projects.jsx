...
const Projects = () => {
  ...
  return (
    <section className="bg-white dark:bg-primary text-black dark:text-white transition-colors duration-300 py-20 px-4 lg:px-16">
      <div className="text-center mb-12">
        <h1 className="text-sm text-accent font-bold tracking-widest">OUR GALLERY</h1>
        <h2 className="text-4xl font-semibold text-gray-800 dark:text-white mt-2">
          Hotel Showcase
        </h2>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
        {projectData.map((project, i) => (
          ...
          >
            ...
            />
            <div className="p-4 bg-white dark:bg-primary text-center">
